...
import { useGetMyDeliveryStatsQuery } from '@/modules/delivery/api/deliveryApi';
import { useGetMyDeliveriesQuery } from '@/modules/orders/api/ordersApi';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-xl p-6">
        ...
        <div className="bg-linear-to-r from-green-500 to-green-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <svg className="w-8 h-8 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-linear-to-r from-purple-500 to-purple-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <svg className="w-8 h-8 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-linear-to-r from-amber-500 to-amber-600 text-white rounded-xl p-6">
          <div className="flex items-center justify-between mb-2">
            <svg className="w-8 h-8 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
