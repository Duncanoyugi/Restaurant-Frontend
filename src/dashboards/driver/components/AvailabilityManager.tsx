...
import { useUpdateOnlineStatusMutation } from '@/modules/users/api/usersApi';
...
const AvailabilityManager: React.FC<AvailabilityManagerProps> = ({ isOnline, setIsOnline }) => {
  ...
  return (
    <div>
      ...
      <div className={`rounded-xl p-6 mb-8 ${isOnline ? 'bg-linear-to-r from-green-500 to-emerald-600' : 'bg-linear-to-r from-gray-600 to-gray-700'} text-white`}>
