...
import { useGetLoyaltyInfoQuery } from '@/modules/customer/api/customerApi';
import { Trophy, Gift, Ticket, UtensilsCrossed, Star, Users, Medal, Award, Gem } from 'lucide-react';

const Rewards: React.FC = () => {
  const { data: loyaltyData } = useGetLoyaltyInfoQuery();

  const loyaltyPoints = loyaltyData?.points ?? loyaltyData?.loyaltyPoints ?? 0;
  const loyaltyTier = loyaltyData?.tier ?? loyaltyData?.loyaltyTier ?? 'Silver';
  const pointsToNextTier = loyaltyData?.pointsToNextTier ?? 500;
  const nextTier = loyaltyData?.nextTier ?? 'Gold';
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Current Status Card */}
      <div className="bg-linear-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-white">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-soft border border-gray-100 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="w-16 h-16 bg-linear-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-3">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-linear-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-linear-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-3">
