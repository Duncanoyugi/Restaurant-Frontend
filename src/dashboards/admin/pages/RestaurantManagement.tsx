...
import { unifiedRestaurantApi } from '@/modules/restaurants/api/unifiedRestaurantApi';
import { FaStore, FaPlus, FaSearch, FaEdit, FaTrash, FaCheck, FaTimes } from 'react-icons/fa';
import type { Restaurant, CreateRestaurantDto } from '@/shared/types/restaurant';
import { validatePhone, validateEmail } from '@/shared/utils/validators';
