import { useGetDashboardOverviewQuery, useGetRevenueAnalyticsQuery } from '@/modules/analytics/api/analyticsApi';
import { useGetAllUsersQuery } from '@/modules/users/api/usersApi';
import { useGetAllRestaurantsQuery } from '@/modules/restaurants/api/unifiedRestaurantApi';
import { useGetAllOrdersQuery } from '@/modules/orders/api/ordersApi';
import { useGetAllReservationsQuery } from '@/modules/reservations/api/reservationsApi';
import { useGetAllRoomBookingsQuery } from '@/modules/rooms/api/roomsApi';
import { AnalyticsPeriod } from '@/modules/analytics/api/analyticsApi';
