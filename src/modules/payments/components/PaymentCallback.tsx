...
import { useVerifyPaymentMutation, useGetPaymentByReferenceQuery } from '@/modules/payments/api/paymentsApi';
import { FaCheckCircle, FaTimesCircle, FaSpinner } from 'react-icons/fa';
import Button from '@/shared/components/Button';
import { getPaymentRedirectPath, parsePaymentMetadata } from '@/modules/payments/api/paymentRedirect';
