...
import { clearCart } from '@/modules/cart/api/cartSlice';
import { useCreateAddressMutation, useCreateOrderMutation, useGetCitiesQuery } from '@/modules/customer/api/customerApi';
import { useGetStatesQuery } from '@/modules/customer/api/customerApi';
import { useInitializePaymentMutation } from '@/modules/payments/api/paymentsApi';
