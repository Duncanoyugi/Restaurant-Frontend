  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-linear-to-r from-primary-600/10 to-secondary-600/10 rounded-full animate-pulse"></div>
        <div className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-linear-to-r from-secondary-600/10 to-primary-600/10 rounded-full animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="relative container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="bg-linear-to-r from-secondary-300 to-primary-300 bg-clip-text text-transparent">
              Bites
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/reservations">
              <Button size="lg" className="shadow-2xl hover:shadow-3xl transform hover:scale-110 flex items-center gap-2">
                <UtensilsCrossed className="h-5 w-5" />
                Make a Reservation
              </Button>
            </Link>
            <Link to="/accommodation">
              <Button variant="outline" size="lg" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 flex items-center gap-2">
