...
const OwnerLayout: React.FC<OwnerLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/dashboard', icon: <Building2 className="w-5 h-5" /> },
    { name: 'Setup Restaurant', href: '/restaurant-setup', icon: <PlusCircle className="w-5 h-5" /> },
    { name: 'Staff Management', href: '/dashboard/staff', icon: <Users className="w-5 h-5" /> },
    { name: 'Driver Management', href: '/dashboard/drivers', icon: <Truck className="w-5 h-5" /> },
