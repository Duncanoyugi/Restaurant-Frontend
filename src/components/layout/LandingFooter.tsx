          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 text-xl font-bold mb-4">
              ...
              <span className="text-white">
                Savory<span className="text-primary-400">Bites</span>
              </span>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              Experience the perfect blend of gourmet dining and luxury accommodation. 
              Where culinary art meets exceptional service.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-white">123 Gourmet Street, Food City</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-white">hello@savorybites.com</p>
              </div>
            </div>
          </div>
        </div>
