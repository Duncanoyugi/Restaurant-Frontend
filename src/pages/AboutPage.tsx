...
import { Star, Heart, Handshake, Sprout, Target } from 'lucide-react';
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <AnimatedSection direction="right">
                <div className="bg-linear-to-br from-primary-100 to-secondary-100 dark:from-primary-900 dark:to-secondary-900 rounded-2xl p-8 h-64 flex items-center justify-center">
              ...
              {teamMembers.map((member, index) => (
                <AnimatedSection key={member.name} direction="up" delay={index * 100}>
                  <div className="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-soft hover:shadow-strong transition-all duration-300">
                    <div className="h-48 bg-linear-to-br from-primary-100 to-secondary-100 dark:from-primary-900 dark:to-secondary-900 flex items-center justify-center">
                      <span className="text-6xl font-bold text-primary-600">TEAM</span>
                    </div>
