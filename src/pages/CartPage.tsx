                  ...
                  <div key={item.id} className="flex items-center justify-between py-4 border-b border-gray-200 last:border-b-0">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-primary-600 font-semibold">KSh {(item.price * 100).toFixed(0)}</p>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-soft p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between">
                    <span>Subtotal</span>
                    <span>KSh {(total * 100).toFixed(0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Tax</span>
                    <span>KSh {(total * 8).toFixed(0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Delivery</span>
                    <span>KSh 299</span>
                  ...
                  <div className="border-t border-gray-200 pt-3 flex justify-between font-semibold text-lg">
                    <span>Total</span>
                    <span>KSh {((total * 100) + (total * 8) + 299).toFixed(0)}</span>
                  </div>
                </div>
