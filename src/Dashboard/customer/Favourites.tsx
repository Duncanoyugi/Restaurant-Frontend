...
import { Heart, UtensilsCrossed, Star, Pizza } from 'lucide-react';
              ...
              >
                <div className="h-48 bg-linear-to-br from-primary-100 to-secondary-100 dark:from-primary-900 dark:to-secondary-900 flex items-center justify-center">
                  {(restaurant as any).logo ? (
                    <span className="text-6xl">{(restaurant as any).logo}</span>
                  ) : (
                    <UtensilsCrossed className="h-16 w-16 text-primary-600" />
                  )}
                </div>
