...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      'bg-linear-to-r from-primary-600 to-secondary-600 hover:from-primary-700 hover:to-secondary-700 text-white shadow-lg hover:shadow-xl focus:ring-primary-500',
    secondary:
